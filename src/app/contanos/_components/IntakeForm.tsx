...
const T = {
  es: {
    eyebrow: "PEDIR UN DIAGNÓSTICO",
    title: "Contame cómo funciona tu operación.",
    sub: "Siete preguntas cortas. Con tus respuestas preparo el diagnóstico: una reunión y tres mejoras con impacto. Te respondo en el día.",
    stepWho: "¿Quién sos?",
    name: "Tu nombre",
    email: "Tu email",
    company: "Empresa o proyecto (opcional)",
    stepNiche: "¿A qué se dedica tu empresa?",
    stepType: "¿Qué necesitás?",
    stepState: "¿Qué tenés hoy?",
    currentUrl: "URL actual (opcional)",
    stepProblem: "¿Qué te está costando tiempo o plata?",
    problemPlaceholder:
      "Ej: los pedidos llegan por WhatsApp y alguien los carga a mano en el sistema. Se pierden algunos y cada tanto se cargan dos veces…",
    ...
    doneTitle: "Recibido.",
    doneBody: "Te respondo dentro del día a",
    doneBack: "Volver al inicio",
    errGeneric: "Algo falló al enviar. Probá de nuevo en un momento.",
  },
  en: {
    eyebrow: "REQUEST A DIAGNOSIS",
    title: "Tell me how your operation works.",
    sub: "Seven short questions. With your answers I prepare the diagnosis: one meeting and three improvements with real impact. I reply the same day.",
    stepWho: "Who are you?",
    name: "Your name",
    email: "Your email",
    company: "Company or project (optional)",
    stepNiche: "What does your company do?",
    stepType: "What do you need?",
    stepState: "What do you have today?",
    currentUrl: "Current URL (optional)",
    stepProblem: "What is costing you time or money?",
    problemPlaceholder:
      "E.g.: orders come in over WhatsApp and someone types them into the system by hand. Some get lost and now and then one is entered twice…",
    problemHint: "The more context, the better the answer. At least a couple of lines.",
    stepBudget: "What's your budget?",
    budgetHint: "A reference so I can propose something realistic, not a commitment.",
    ...
    review: "Review & send",
    doneTitle: "Got it.",
    doneBody: "I'll reply within the day to",
    doneBack: "Back to home",
    errGeneric: "Something failed while sending. Try again in a moment.",
  },
  pt: {
    eyebrow: "PEDIR UM DIAGNÓSTICO",
    title: "Me conte como funciona a sua operação.",
    sub: "Sete perguntas curtas. Com as suas respostas preparo o diagnóstico: uma reunião e três melhorias com impacto. Respondo no mesmo dia.",
    stepWho: "Quem é você?",
    name: "Seu nome",
    email: "Seu email",
    company: "Empresa ou projeto (opcional)",
    stepNiche: "O que a sua empresa faz?",
    stepType: "O que você precisa?",
    stepState: "O que você tem hoje?",
    currentUrl: "URL atual (opcional)",
    stepProblem: "O que está custando tempo ou dinheiro?",
    problemPlaceholder:
      "Ex.: os pedidos chegam pelo WhatsApp e alguém digita à mão no sistema. Alguns se perdem e de vez em quando um é lançado duas vezes…",
    ...
    doneTitle: "Recebido.",
    doneBody: "Respondo no mesmo dia para",
