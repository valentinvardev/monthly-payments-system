...
export function LangToggle({ locale }: { locale: Locale }) {
  ...
  return (
    <select
      ...
      aria-label="Idioma"
      className="h-8 cursor-pointer appearance-none border border-white/12 bg-[#161616] px-2.5 pr-6 font-mono text-[10px] uppercase tracking-[0.14em] text-white/75 transition hover:bg-[#1f1f1f] focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0070F3]"
      style={{
        backgroundImage:
